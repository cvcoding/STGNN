...
class RNNCell(base_layer.Layer):
  ...
  def __call__(self, inputs, state, input_nextt_gate, output_ta_t, time, scope=None):
...
class DropoutWrapper(RNNCell):
  ...
  def __call__(self, inputs, state, input_nextt_gate, output_ta_t, time, scope=None):
    ...
    output, new_state = self._cell(inputs, state, input_nextt_gate, output_ta_t, time, scope=scope)
